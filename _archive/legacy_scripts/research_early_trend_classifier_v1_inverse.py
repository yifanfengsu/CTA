...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "reports" / "research" / "early_trend_classifier_v1_inverse"
...
def render_report(
    ...
    return (
        ...
        "ETC-v1 Inverse 是 ETC-v1 的符号翻转版本。原版 ETC-v1 发现 composite score 呈反向："
        "high-score 样本的 early_trend_rate 低于 low-score 样本，"
        "且 top10/bottom30 的 PnL 排序在 OOS 中与预期相反。"
        "因此本版本将所有 6 个 COMPOSITE_TERMS 符号翻转，原版 bottom30 变为新版 top30。"
        "本研究是 research-only，不修改策略、不进入 demo/live。\n\n"
        "## 2. 趋势早期标签如何定义？\n"
