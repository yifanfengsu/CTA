...
- **但 15/15 全部未通过稳健性验证（验证级，2026-06-11）**：单笔集中度 V1 通杀
  （剔除 top 5% 交易后毛利 −$3k~−$142k 全转负）；11/15 死时间稳健（A/C3 族 2023
  贡献 ≥98%）；bootstrap 单笔均值 15/15 不显著；short 侧 15/15 净亏。贝塔定性为
  **未通过验证的混合体**：非纯贝塔（头部配置 net/DD 10–17× 优于 B&H 的 0.21，
  且在 B&H 亏损的 DOGE/LINK 上盈利），但以当前形态无一可宣称稳健。
  B&H 基准本身：净 $64k / maxDD $313k / funding 吃掉毛利 46%。
  [`reports/trend_validation_20260611/`]
