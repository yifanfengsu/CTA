...
Flow vs价格趋势对照完成于2026-06-29T12:58:50Z/flow persistence:前瞻预测区分不出噪声(ACF记忆真实但不前瞻)/flow vs price:不如/信号重合度:低(~0.45-0.53,flow确为不同信号但更差)/速度检验:flow优势全在HFT窗口(亚秒,corr未来+0.056@1s→0@60s)/判定:不过-用价格即可/是否退化为flow过滤B2_4h:否,严守边界/已push:待确认
