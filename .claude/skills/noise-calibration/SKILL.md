...
- **协整 231 对 ≈ 纯噪声**：pairs 研究 C1 报"平均 12.48 对/窗协整显著"，当时无噪声
  ...
  教训显式修复（出处：`research/_closed/crypto_tick/factor_scale/reports/factor_scale_feasibility_20260628/` POSITIONING 段、
...
- **冲击"回弹"= bid-ask bounce**：order_flow 的冲击后回弹曲线与随机时点安慰剂
  ...
  点差当成 edge（出处：`research/_closed/crypto_tick/order_flow_exhaustion/reports/order_flow_exhaustion_feasibility_20260628/` Q2）。
...
- `research/_closed/crypto_tick/factor_scale/reports/factor_scale_feasibility_20260628/README.md` Q2
- `research/_closed/crypto_perp/pairs_cointegration/reports/pairs_cointegration_20260613/`（漏装噪声标定的教训，11.55 噪声底算术）
- `research/_closed/crypto_tick/order_flow_exhaustion/reports/order_flow_exhaustion_feasibility_20260628/README.md` Q2（随机时点安慰剂 + 半价差地板）
